...
<body>
	...
	<section id="edit-DB2TriplesJob" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${DB2TriplesJobInstance?.id}" />
			<g:hiddenField name="version" value="${DB2TriplesJobInstance?.version}" />
