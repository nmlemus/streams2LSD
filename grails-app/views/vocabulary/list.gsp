...
<section id="list-vocabulary" class="first">

    <table class="table table-bordered margin-top-medium">
        <thead>
        <tr>

            <g:sortableColumn property="vocabulary_name"
                              title="${message(code: 'vocabulary.vocabulary_name.label', default: 'Vocabularyname')}"/>
            ...
            <g:sortableColumn property="endpoint"
                              title="${message(code: 'vocabulary.endpoint.label', default: 'Endpoint')}"/>
        ...
        <g:each in="${vocabularyInstanceList}" status="i" var="vocabularyInstance">
            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                ...
                <td><g:link action="show"
                            id="${vocabularyInstance.id}">${fieldValue(bean: vocabularyInstance, field: "vocabulary_name")}</g:link></td>
