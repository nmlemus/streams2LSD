...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" type="text/css" media="screen" href="${resource(dir:'css', file: 'styles/bootstrap.css')}">
    <link rel="stylesheet" type="text/css" media="screen" href="${resource(dir:'css', file: 'styles/grid.css')}">
...
<div style="min-height: 40px; margin-top: 50px; box-shadow: none; -webkit-box-shadow: none;" class="navbar navbar-default navbar-fixed-top" role="navigation">
    <ul id="myTab" style="min-width: 480px; box-shadow: none; -webkit-box-shadow: none; border: none;" class="nav nav-tabs">
        <li style="margin-left: 20px;" class="active"><a data-tab="billing" href="#billing">Billing Information</a></li>
        <li><a data-tab="fitness" href="#fitness">Fitness & Exercise</a></li>
        <li><a data-tab="employee" href="#employee">Employee Details</a></li>
    </ul>
</div>
